...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Bola parvarishi tatili </h2>
...
<script type="text/javascript">
  ...
  let submitBtn = document.getElementById('ok1');
    submitBtn.addEventListener("click", function submit(e) {
      ...
      loadingStart();
      $.ajax({
        url: "core/addbolaparvarishi.php",
        type: 'POST',
        processData: false,
        contentType: false,
        ...
        success: function (data) {
          ...
          if (obj.xatolik==0) {
            ...
            setTimeout(() => {
              location.href = "bolaparvarishi.php";
            }, 3500);
          } else {
            $('#_csrf').val(obj._csrf);
            toast.create({

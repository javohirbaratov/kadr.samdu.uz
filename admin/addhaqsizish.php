...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Haq to`lanmaydigan tatildan so`ng ishga chiqish </h2>
      <ul class="page-header__nav">
        ...
        <li>
          Haq to`lanmaydigan tatildan so`ng ishga chiqish 
        </li>
      </ul>
    </div>
      ...
      <div class="form-group">
        <div class="card">
          <div class="card-header">
            <p>Haq to`lanmaydigan tatildan so`ng ishga chiqish  </p>
          </div>
          <div class="card-body">
...
<script type="text/javascript">
  ...
  let submitBtn = document.getElementById('ok1');
    submitBtn.addEventListener("click", function submit(e) {
      ...
      loadingStart();
      $.ajax({
        url: "core/add.php?table=<?=str_rot13("haqsizish")?>&soni=<?=6*$keyuser?>",
        type: 'POST',
        processData: false,
        contentType: false,

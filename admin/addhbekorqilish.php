...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Hayfsan bekor qilish</h2>
...
<script type="text/javascript">
  ...
  let submitBtn = document.getElementById('ok1');
    submitBtn.addEventListener("click", function submit(e) {
      ...
      loadingStart();
      $.ajax({
        url: "core/add.php?table=<?=str_rot13("hbekorqilish")?>&soni=<?=6*$keyuser?>",
        type: 'POST',
        processData: false,
        contentType: false,

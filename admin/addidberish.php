...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Ilmiy daraja berilganligini tasdiqlash </h2>
      <ul class="page-header__nav">
        ...
        <li>
          Ilmiy daraja berilganligini tasdiqlash 
        </li>
      </ul>
    </div>
      ...
      <div class="form-group">
        <div class="card">
          <div class="card-header">
            <p>Ilmiy daraja berilganligini tasdiqlash </p>
          </div>
          <div class="card-body">
...
<script type="text/javascript">
  ...
  let submitBtn = document.getElementById('ok1');
    submitBtn.addEventListener("click", function submit(e) {
      ...
      loadingStart();
      $.ajax({
        url: "core/add.php?table=<?=str_rot13("idberish")?>&soni=<?=6*$keyuser?>",
        type: 'POST',
        processData: false,
        contentType: false,

...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Mehnat tatilidan chaqirib olish </h2>
      <ul class="page-header__nav">
        ...
        <li>
          Mehnat tatilidan chaqirib olish 
        </li>
      </ul>
    </div>
      ...
      <div class="form-group">
        <div class="card">
          <div class="card-header">
            <p>Mehnat tatilidan chaqirib olish  </p>
          </div>
          <div class="card-body">
...
<script type="text/javascript">
  ...
  let submitBtn = document.getElementById('ok1');
    submitBtn.addEventListener("click", function submit(e) {
      ...
      loadingStart();
      $.ajax({
        url: "core/add.php?table=<?=str_rot13("mehnattatilidanchaqirish")?>&soni=<?=7*$keyuser?>",
        type: 'POST',
        processData: false,
        contentType: false,
        ...
        success: function (data) {
          ...
          if (obj.xatolik==0) {
            ...
            setTimeout(() => {
              location.href = "mehnattatilidanchaqirish.php";
            }, 3500);
          } else {
            $('#_csrf').val(obj._csrf);
            toast.create({

...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Mehnat shartnomasini bekor qilish </h2>
      ...
      <div class="form-group">
        <div class="card">
          <div class="card-header">
            <p>Mehnat shartnomasini bekor qilish </p>
          </div>
          <div class="card-body">
...
<script type="text/javascript">
  ...
  let submitBtn = document.getElementById('ok1');
    submitBtn.addEventListener("click", function submit(e) {
      ...
      loadingStart();
      $.ajax({
        url: "core/add.php?table=<?=str_rot13("mshbekor")?>&soni=<?=5*$keyuser?>",
        type: 'POST',
        processData: false,
        contentType: false,

...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Oylik maoshiga ustama tayinlash</h2>
      <ul class="page-header__nav">
        ...
        <li>
          Oylik maoshiga ustama tayinlash
        </li>
      </ul>
    </div>
      ...
      <div class="form-group">
        <div class="card">
          <div class="card-header">
            <p>Oylik maoshiga ustama tayinlash </p>
          </div>
          <div class="card-body">
            <form id="form" action="index.php" method="post">
              ...
              <div class="form-group">
                ...
                <input
                    ...
                    required
                />
                <div class="invalid-feedback">Foizni kiriting</div>
              </div>
...
<script type="text/javascript">
  ...
  let submitBtn = document.getElementById('ok1');
    submitBtn.addEventListener("click", function submit(e) {
      ...
      loadingStart();
      $.ajax({
        url: "core/add.php?table=<?=str_rot13("ustama")?>&soni=<?=6*$keyuser?>",
        type: 'POST',
        processData: false,
        contentType: false,

...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Bola parvarish ta`tilidan so`ng ishga chiqish</h2>
      <ul class="page-header__nav">
        ...
        <li>
          Bola parvarish ta`tilidan so`ng ishga chiqish
        </li>
      </ul>
    </div>
          ...
          <tbody id="tbl">
            <?php 
              ...
              foreach($fetch as $value){
                ...
                if(strlen($value['bpish'])>1){
                  $file='<a target="_blank" href="../docs/bpish/'.$value['bpish'].'">Yuklash</a>';
                }else{
...
function modalinfos(event) {
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit?table=<?=str_rot13("bpish")?>",
        type: 'POST',
        processData: false,
        contentType: false,

...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Fakultet, Bo`lim, Bino, Grant</h2>
          ...
          <tbody id="tbl">
            <?php
              ...
              foreach($fetch as $value){
                ...
                $kadrb = Functions::getbyid("kadrlarbulimi",$value['kadrbulimi_id']);
                ...
                echo ('
                  ...
                  <tr>
                    ...
                    <td class="sha1'.$indexs.'" id="'.$value['kadrbulimi_id'].'">'.$ka.'</td>
                    <td class="sha1'.$indexs.'">'.$value['izoh'].'</td>
                    <td>
  ...
  <h1>Taxrirlash</h1>
              ...
              <div class="form-group">
                ...
                <input id="name"
                    ...
                    required
                />
                <div class="invalid-feedback">Bo`lim nomi kiriting</div>
              </div>
              <div class="form-group">
                <label>Kadrlar bo`limini tanlang</label>
                <select name="kadrbulimi_id" id="kadrbulimi_id"  required class="form-select">
                  <?php
...
function modalinfos(event) {
  ...
  var infos = new Array();
    ...
    document.getElementById('kadrbulimi_id').value=arr[2].id;
    document.getElementById('izoh').value=infos[3];
  ...
  function delinfo(id) {
    $('.modal, #modal11').removeClass('display');
        ...
        modal.close();
    $.ajax({
      url:"core/delete/deletebulim.php",
      method:"get",
      data:{
        id:id,

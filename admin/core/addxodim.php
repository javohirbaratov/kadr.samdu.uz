<?
	...
	if (isset($_POST['familya']) && isset($_POST['ism']) && isset($_POST['otch']) && isset($_POST['jshir']) && isset($_POST['inn']) && isset($_POST['seriya']) && isset($_POST['nomer']) && isset($_POST['pasportdate']) && isset($_POST['pasportjoy']) && isset($_POST['pasportenddate']) && isset($_POST['birthdate']) && isset($_POST['birthplace']) && isset($_POST['jinsi']) && isset($_POST['millati']) && isset($_POST['fuqaroligi']) && isset($_POST['partiyaviyligi']) && isset($_POST['xarbiy']) && isset($_POST['mjshaxs']) && isset($_POST['tkmuddati']) && isset($_POST['manzil']) && isset($_POST['doimiy']) && isset($_POST['telefon']) && isset($_POST['telegram_id']) && isset($_POST['pochta']) && isset($_POST['oilaviyahvoli']) && isset($_POST['viloyat_id']) && isset($_POST['tuman_id'])  ){
		...
		if($_POST['_csrf']!=$_SESSION['_csrf']){
			...
			$fetch = Functions::addxodim($familya, $ism, $otch, $jshir, $inn, $seriya, $nomer, $pasportdate, $pasportjoy, $pasportenddate, $passport, $birthdate, $birthplace, $jinsi, $millati, $fuqaroligi, $partiyaviyligi, $xarbiy, $mjshaxs, $tkmuddati, $tkguvohnoma, $manzil, $doimiy, $telefon, $telegram_id, $pochta, $rasm, $oilaviyahvoli, $viloyat_id, $tuman_id);

...
<div id="modal2" class="modal_info">
  ...
  <div id="form" class="form-group">
                <label>Diplom turining nomi</label>
                <input id="newname" 
                    class="form-control was-validation"
                    type="text"
                    placeholder="Diplom turining nomini kiriting"
                    name="seriya"
                    required
                />
                <div class="invalid-feedback">Diplom turining nomini kiriting</div>
  </div>
...
function modalinfos(event) {
  ...
  var infos = new Array();
    ...
    document.getElementById('newname').value=infos[1];

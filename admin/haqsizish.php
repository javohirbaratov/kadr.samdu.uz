  ...
  <div class="container">
    ...
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("haqsizish");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['haqsizish'])>1){
                  $file='<a target="_blank" href="../docs/haqsizish/'.$value['haqsizish'].'">Yuklash</a>';
                }else{
...
function modalinfos(event) {
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit.php?table=<?=str_rot13("haqsizish")?>",
        type: 'POST',
        processData: false,
        contentType: false,

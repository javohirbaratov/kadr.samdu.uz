...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Harbiy o’quv mashg’ulotlaridan so`ng ishga chiqish</h2>
      <ul class="page-header__nav">
        ...
        <li>
          Harbiy o’quv mashg’ulotlaridan so`ng ishga chiqish
        </li>
      </ul>
    </div>
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("harbiyish");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['harbiyish'])>1){
                  $file='<a target="_blank" href="../docs/harbiyish/'.$value['harbiyish'].'">Yuklash</a>';
                }else{
...
function modalinfos(event) {
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit?table=<?=str_rot13("harbiyish")?>",
        type: 'POST',
        processData: false,
        contentType: false,

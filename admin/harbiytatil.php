...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Harbiy o`quv mashg`ulotiga yuborilganlar</h2>
      <ul class="page-header__nav">
        ...
        <li>
          Harbiy o`quv mashg`ulotiga yuborilganlar
        </li>
      </ul>
    </div>
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("harbiytatil");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['harbiytatil'])>1){
                  $file='<a target="_blank" href="../docs/harbiytatil/'.$value['harbiytatil'].'">Yuklash</a>';
                }else{
...
function modalinfos(event) {
  ...
  var infos = new Array();
    ...
    document.getElementById('lavozim1').value=infos[3];
    document.getElementById('sanadan').value=infos[4];
    document.getElementById('sanagacha').value=infos[5];
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit?table=<?=str_rot13("harbiytatil")?>",
        type: 'POST',
        processData: false,
        contentType: false,
  ...
  var infos = new Array();
    ...
    for(var i=0; i< arr.length; i++){
        infos.push(arr[i].innerHTML);
            ...
            loadFile(
                "../docs/shablon/homiladorliktatili.docx",

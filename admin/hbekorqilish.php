  ...
  <div class="container">
    ...
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("hbekorqilish");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['hbekorqilish'])>1){
                  $file='<a target="_blank" href="../docs/hbekorqilish/'.$value['hbekorqilish'].'">Yuklash</a>';
                }else{
                ...
                echo ('
                  ...
                  <tr>
                    ...
                    <td class="sha1'.$indexs.'">'.$value['hbuyruq'].'</td>
...
<div id="modal2" class="modal_info">
  <h1>Taxrirlash</h1>
              ...
              <div class="form-group">
                <label>Hayfsan buyruq raqami</label>
                <input
                    class="form-control"
                    type="text"
                    placeholder="Hayfsan buyruq raqamini kiriting"
                    name="hbuyruq"
                    id="hbuyruq"
                    required
                />
                <div class="invalid-feedback">Hayfsan buyruq raqamini kiriting</div>
              </div>
...
function modalinfos(event) {
  ...
  var infos = new Array();
    ...
    document.getElementById('hbuyruq').value=infos[6];
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit?table=<?=str_rot13("hbekorqilish")?>",
        type: 'POST',
        processData: false,
        contentType: false,
  ...
  var infos = new Array();
    ...
    for(var i=0; i< arr.length; i++){
        infos.push(arr[i].innerHTML);
            ...
            loadFile(
                "../docs/shablon/hbekorqilish.docx",

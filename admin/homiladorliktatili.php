...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Homiladorlik ta`tili</h2>
    ...
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("homiladorliktatili");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['file'])>1){
                  $file='<a target="_blank" href="../docs/homiladorliktatili/'.$value['file'].'">Yuklash</a>';
                }else{
...
function modalinfos(event) {
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edithomiladorliktatili",
        type: 'POST',
        processData: false,
        contentType: false,
  ...
  function delinfo(id) {
    $('.modal, #modal11').removeClass('display');
        ...
        modal.close();
    $.ajax({
      url:"core/delete/deletehomiladorliktatili.php",
      method:"get",
      data:{
        id:id,

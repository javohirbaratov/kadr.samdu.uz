  ...
  <div class="container">
    ...
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("idberish");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['idberish'])>1){
                  $file='<a target="_blank" href="../docs/idberish/'.$value['idberish'].'">Yuklash</a>';
                }else{
                ...
                echo ('
                  ...
                  <tr>
                    ...
                    <td class="sha1'.$indexs.'">'.$value['daraja'].'</td>
...
function modalinfos(event) {
  ...
  var infos = new Array();
    ...
    document.getElementById('daraja').value=infos[5];
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit?table=<?=str_rot13("idberish")?>",
        type: 'POST',
        processData: false,
        contentType: false,

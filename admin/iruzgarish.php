  ...
  <div class="container">
    ...
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("iruzgarish");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['iruzgarish'])>1){
                  $file='<a target="_blank" href="../docs/iruzgarish/'.$value['iruzgarish'].'">Yuklash</a>';
                }else{
                ...
                echo ('
                  ...
                  <tr>
                    ...
                    <td class="sha1'.$indexs.'" >'.$value['kimga'].'</td>
...
<div id="modal2" class="modal_info">
  <h1>Taxrirlash</h1>
              ...
              <div class="form-group">
                <label>Kimga o`tgani</label>
                <input
                    class="form-control"
                    type="text"
                    placeholder="Kimga o`tganini kiriting"
                    name="kimga"
                    id="kimga"
                    required
                />
                <div class="invalid-feedback">Kimga o`tganini kiriting</div>
              </div>
...
function modalinfos(event) {
  ...
  var infos = new Array();
    ...
    document.getElementById('kimga').value=infos[4];
    document.getElementById('asos').value=infos[5];
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit?table=<?=str_rot13("iruzgarish")?>",
        type: 'POST',
        processData: false,
        contentType: false,

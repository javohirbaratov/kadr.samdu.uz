...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Kafedra, Bo`linmalar </h2>
  ...
  <h1>Taxrirlash</h1>
              ...
              <div class="form-group">
                ...
                <input
                    class="form-control"
                    type="text"
                    placeholder="Kafedra nomi kiriting"
                    name="name"
                    id="name"
                    required
                />
                <div class="invalid-feedback">Kafedra nomi kiriting</div>
              </div>
              <div class="form-group">
                ...
                <div class="invalid-feedback">Fakultetni tanlang</div>
              </div>
...
function modalinfos(event) {
  ...
  function delinfo(id) {
    $('.modal, #modal11').removeClass('display');
        ...
        modal.close();
    $.ajax({
      url:"core/delete/deletekafedra.php",
      method:"get",
      data:{
        id:id,

            ...
            <?php 
              ...
              foreach($fetch as $value){
                ...
                if(strlen($value['file'])>1){
                  $file='<a target="_blank" href="../docs/malaka/'.$value['file'].'">Yuklash</a>';
                }else{
                ...
                echo ('
                  ...
                  <tr>
                    ...
                    <td class="sha1'.$indexs.'">'.$value['begin'].'</td>
                    <td class="sha1'.$indexs.'">'.$value['end'].'</td>
...
function modalinfos(event) {
  ...
  var infos = new Array();
    ...
    document.getElementById('begin').value=infos[2];
    document.getElementById('end').value=infos[3];
  ...
  function delinfo(id) {
    $('.modal, #modal11').removeClass('display');
        ...
        modal.close();
    $.ajax({
      url:"core/delete/deletemalaka.php",
      method:"get",
      data:{
        id:id,

  ...
  <div class="container">
    ...
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("mehnattatilidanchaqirish");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['mehnattatilidanchaqirish'])>1){
                  $file='<a target="_blank" href="../docs/mehnattatilidanchaqirish/'.$value['mehnattatilidanchaqirish'].'">Yuklash</a>';
                }else{
  ...
  <h1>Taxrirlash</h1>
              ...
              <div class="form-group">
                ...
                <input
                    ...
                    name="mehnattatilidanchaqirish"
                    id="mehnattatilidanchaqirish"
                    required
                />
...
function modalinfos(event) {
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit?table=<?=str_rot13("mehnattatilidanchaqirish")?>",
        type: 'POST',
        processData: false,
        contentType: false,
  ...
  function delinfo(id) {
    ...
    $.ajax({
      ...
      data:{
        id:id,
        table:'mehnattatilidanchaqirish',
  ...
  var infos = new Array();
    ...
    for(var i=0; i< arr.length; i++){
        infos.push(arr[i].innerHTML);
            ...
            loadFile(
                "../docs/shablon/mehnattatilidanchaqirish.docx",

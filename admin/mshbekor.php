  ...
  <div class="container">
    ...
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("mshbekor");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['mshbekor'])>1){
                  $file='<a target="_blank" href="../docs/mshbekor/'.$value['mshbekor'].'">Yuklash</a>';
                }else{
...
function modalinfos(event) {
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit?table=<?=str_rot13("mshbekor")?>",
        type: 'POST',
        processData: false,
        contentType: false,

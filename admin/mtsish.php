...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">Mehnat ta`tilidan so`ng ishga chiqish</h2>
      <ul class="page-header__nav">
        ...
        <li>
          Mehnat ta`tilidan so`ng ishga chiqish
        </li>
      </ul>
    </div>
          ...
          <tbody id="tbl">
            <?php 
              ...
              foreach($fetch as $value){
                ...
                if(strlen($value['mtsish'])>1){
                  $file='<a target="_blank" href="../docs/mtsish/'.$value['mtsish'].'">Yuklash</a>';
                }else{
...
function modalinfos(event) {
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit.php?table=<?=str_rot13("mtsish")?>",
        type: 'POST',
        processData: false,
        contentType: false,

  ...
  <div class="container">
    ...
    <div class="page-content">
        <table id="MyTable" class="display">
          ...
          <tbody id="tbl">
            <?php 
              $fetch = Functions::getall("sababyuq");
              $no=0;
              foreach($fetch as $value){
                ...
                if(strlen($value['sababyuq'])>1){
                  $file='<a target="_blank" href="../docs/sababyuq/'.$value['sababyuq'].'">Yuklash</a>';
                }else{
...
function modalinfos(event) {
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit?table=<?=str_rot13("sababyuq")?>",
        type: 'POST',
        processData: false,
        contentType: false,

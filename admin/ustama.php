...
<main>
  <div class="container">
    <div class="page-header">
      <h2 class="page-header__title">haq to`lanmaydigan ta`tildan so`ng ishga chiqish</h2>
      <ul class="page-header__nav">
        ...
        <li>
          haq to`lanmaydigan ta`tildan so`ng ishga chiqish
        </li>
      </ul>
    </div>
          ...
          <tbody id="tbl">
            <?php 
              ...
              foreach($fetch as $value){
                ...
                if(strlen($value['ustama'])>1){
                  $file='<a target="_blank" href="../docs/ustama/'.$value['ustama'].'">Yuklash</a>';
                }else{
                ...
                echo ('
                  ...
                  <tr>
                    ...
                    <td class="sha1'.$indexs.'">'.$value['foiz'].'</td>
...
function modalinfos(event) {
  ...
  function taxririnfo(id) {
    $.ajax({
      url:"core/edit/edit.php?table=<?=str_rot13("ustama")?>",
        type: 'POST',
        processData: false,
        contentType: false,

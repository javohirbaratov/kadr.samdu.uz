            ...
            <div class="tile-body">
              <form id="formdata2">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Lavozim nomini kiriting" name="lavozim_name" id="bulim_name_form2">
                </div>
                <div class="form-group">
                ...
                <div class="form-group razryad">
                  ...
                  <input class="form-control" type="number" placeholder="Razryadini kiriting" name="razryad" id="razryad">
                </div>
                <div class="form-group razryad">
                  <label class="control-label">Tarif koef.</label>
                  <input class="form-control" type="number" placeholder="Koeffitsiyentni kiriting" id="koef" name="koef">
                </div>
                <div class="form-group bazaviy">
                  <label class="control-label">Oylik ish haqqi</label>
                  <input class="form-control" type="number" placeholder="Oylik maoshni kiriting" id="oylik" name="oylik">
                </div>
                <div class="form-group">
                  <label class="control-label">Jami shtat</label>
                  <input class="form-control" type="number" placeholder="Jami shtatni kiriting" id="shtat" name="shtat">
                </div>
                <input type="hidden" name="action" value="insertlavozim">               
              </form>
            </div>

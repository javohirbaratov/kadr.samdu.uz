      ...
      if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $sql = mysqli_query($link,"SELECT * FROM workplace WHERE id = '$id'");
      ...
      <body class="app sidebar-mini">
        ...
        <main class="app-content">
          ...
          <div class="col-md-12">
            <div class="tile">
             <h3 class="tile-title">Hozirgi ish joyi</h3>  
             <div class="tile-body">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="text" name="malumot" class="form-control" readonly value="<?=$q['malumot']?>">
              </div>

              <div class="form-group col-md-3">
                <label class="control-label">Shartnoma raqami</label>
                <input type="text" name="shartnoma" class="form-control" readonly value="<?=$q['shartnomaraqam']?>">
              </div>

              <div class="form-group col-md-3">
                <label class="control-label">Shtat birligi</label>
                <input type="text" name="shtat" class="form-control" readonly value="<?=$q['shtat']?>">
              </div>

              <div class="form-group col-md-3">
                <label class="control-label">Sana</label>
                <input type="text" name="sana" class="form-control" readonly value="<?=$q['sana']?>">
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Kadrlar bo'limi</label>
                <input type="text" name="sana" class="form-control" readonly value="<?=$kadrlarbulimi['name']?>">
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Bo'lim</label>
                <input type="text" name="sana" class="form-control" readonly value="<?=$bulimlar['name']?>">
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Bo'linma</label>
                <input type="text" name="sana" class="form-control" readonly value="<?=$kafedralar['name']?>">
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Lavozim</label>
                <input type="text" name="sana" class="form-control" readonly value="<?=$lavozimlar['lavozim']?>">
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Faoliyat turi</label>
                <input type="text" name="sana" class="form-control" readonly value="<?=$q['urindosh']?>">
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Muddat</label>
                <input type="text" name="sana" class="form-control" readonly value="<?=$q['muddat']?>">
              </div>
              <div class="form-group col-md-3">
                <label class="control-label">Sinov muddati</label>
                <input type="text" name="sana" class="form-control" readonly value="<?=$q['sinov']?> oy">
              </div>
    ...
    <div class="col-md-12">
      <div class="tile">
        <h3 class="tile-title">O'zgartirish</h3> 
        <div class="tile-body">

          <form class="row" action="insert_buyruq.php" method="POST">
            <input type="hidden" name="id" value="<?=$id?>">
            <input type="hidden" name="_csrf" value="<?=$_SESSION['_csrf']?>">
            <input type="hidden" name="action" value="changelavozim">
           <div class="form-group col-md-3">
            <label class="control-label">F.I.O</label>
            <input type="text" name="fio" class="form-control" readonly value="<?=strtoupper(utf8_decode($l['familya']))?>  <?=strtoupper(utf8_decode($l['ism']))?>  <?=strtoupper(utf8_decode($l['otch']))?> ">
          </div>
